...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
   ...
   // $smarty->assign('hot_goods',       get_recommend_goods('hot'));     // 热点文章
	$smarty->assign('home_cate_1',     get_goods_homepage(1));     // 热点文章
	$smarty->assign('home_cate_2',     get_goods_homepage(2));     // 热点文章
	$smarty->assign('home_cate_3',     get_goods_homepage(81));     // 热点文章
    $smarty->assign('home_cate_4',     get_goods_homepage(51));     // 热点文章
    $smarty->assign('home_cate_5',     get_goods_homepage(52));     // 热点文章
    $smarty->assign('home_cate_6',     get_goods_homepage(77));     // 热点文章
...
function get_goods_homepage($cat_id){
	 $children = get_children($cat_id);
	 $sort  = 'last_update';
	 $order = 'DESC';
	 $size = 10;
	 $page = 1;
	 $data['cate_list'] = get_single_categories_tree($cat_id);
	 $data['goods'] = category_get_goods2($children, $brand, $min, $max, $ext, $size, $page, $sort, $order);
	 //print_r($data);
	 return $data;
