...
<h1 class="topTit"><?php echo $this->_var['lang']['promotion_info']; ?></h1>
...
?>
    ...
    <?php endif; ?>
    <a href="<?php echo $this->_var['item']['url']; ?>" title="<?php echo $this->_var['lang'][$this->_var['item']['type']]; ?> <?php echo $this->_var['item']['act_name']; ?><?php echo $this->_var['item']['time']; ?>"><?php echo sub_str($this->_var['item']['act_name'],8); ?></a><br />
