<div class="mod2Tit"><?php echo $this->_var['lang']['user_comment']; ?></div>
...
?>
 <div class="commentsTit">
  <?php if ($this->_var['comment']['username']): ?>
	...
	<?php endif; ?>
  给出 <img src="themes/3cshop/images/stars<?php echo $this->_var['comment']['rank']; ?>.gif" alt="<?php echo $this->_var['comment']['comment_rank']; ?>" /> 评分
...
<div class="Goodpromotion blank">
      <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
       <table border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td align="right" style="width:150px;"><?php echo $this->_var['lang']['username']; ?>:</td>
          <td style="width:150px;"  <?php if (! $this->_var['enabled_captcha']): ?><?php endif; ?>><?php if ($_SESSION['user_name']): ?><?php echo $_SESSION['user_name']; ?><?php else: ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?></td>
        </tr>
        <tr>
          <td align="right" style="width:150px;">E-mail:</td>
          <td>
          <input type="text" name="email" id="email"  maxlength="100" value="<?php echo htmlspecialchars($_SESSION['email']); ?>" class="InputBorder"/>
          </td>
        </tr>
        <tr>
          <td align="right" style="width:150px;"><?php echo $this->_var['lang']['comment_rank']; ?>:</td>
          <td>
          <input name="comment_rank" type="radio" value="1" id="comment_rank1" /> <img src="themes/3cshop/images/stars1.gif" />
          <input name="comment_rank" type="radio" value="2" id="comment_rank2" /> <img src="themes/3cshop/images/stars2.gif" />
          <input name="comment_rank" type="radio" value="3" id="comment_rank3" /> <img src="themes/3cshop/images/stars3.gif" />
          <input name="comment_rank" type="radio" value="4" id="comment_rank4" /> <img src="themes/3cshop/images/stars4.gif" />
          <input name="comment_rank" type="radio" value="5" checked="checked" id="comment_rank5" /> <img src="themes/3cshop/images/stars5.gif" />
          </td>
        </tr>
        <tr>
          <td align="right" valign="top" style="width:150px;"><?php echo $this->_var['lang']['comment_content']; ?>:</td>
          <td>
          <textarea name="content" class="InputBorder" cols="50" style="width:500px;"></textarea>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_35524000_1372986248');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_35524000_1372986248']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_35524000_1372986248']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
