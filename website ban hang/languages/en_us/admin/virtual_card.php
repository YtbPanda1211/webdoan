...
$_LANG['user_guide'] = 'Cách sử dụng:' .
        ...
        '<ol>' .
          ...
          '<li>Chuỗi mã hóa được lưu giữ trong các tập tin bao gồm /lib_code.php, tương ứng luôn là AUTH_KEY</li>' .
          '<li>Mã hóa chuỗi Nếu bạn muốn thay đổi, đó là lần đầu tiên cần thiết để sửa đổi các tập tin lib_code.php, các OLD_AUTH_KEY strings đặt để thay đổi trước khi sử dụng khả năng mật mã, mật mã AUTH_KEY được sửa đổi cho loạt mới, và sau đó trong hộp văn bản bên dưới gốc loạt và mật mã mới chuỗi mã hóa, điểm \'để xác định\' nút </li>' .
        '</ol>';
