...
Cách sử dụng:
          ...
          3: Nếu bạn không cần bất kỳ của người sử dụng tích hợp hệ thống, chọn VOC(VIETORDER.COM) cài đặt plug-in, bạn có thể gỡ bỏ tất cả những tích hợp của plug-in. 
                           </pre>';
